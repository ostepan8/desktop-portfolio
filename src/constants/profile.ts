...
export const PROFILE = {
  ...
  // Keep this human — the resume covers credentials; this covers who I am.
  bio:
    "Chicago kid in Boston. I spend most of my time building AI agents and " +
    "the infrastructure that keeps them honest, and the rest of it building " +
    "things nobody asked for — a home-automation JARVIS, my own programming " +
    "language, this desktop. Everything else you'd want to know is one " +
    "click away in the resume. Poke around: the terminal works.",
